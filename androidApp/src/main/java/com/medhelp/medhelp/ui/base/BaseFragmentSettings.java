...
public abstract class BaseFragmentSettings extends PreferenceFragment implements MvpView {
    ...
    public void showLoading() {
        ...
        if(getActivity().getApplicationContext()!=null)
            dialog = MainUtils.showLoadingDialog(getActivity().getApplicationContext());
    }
